...
export interface Workspace {
  ...
  devServerUrl?: string; // 添加开发服务器URL字段
  files: FileNode[];
  activeFile?: string;
  settings: {
    theme: "light" | "dark";
...
interface WorkspaceState {
  ...
  updateDevServerUrl: (devServerUrl: string) => void;
  ...
  deleteFile: (fileId) => {
    ...
    set({
      workspace: {
        ...
        activeFile:
          workspace.activeFile === fileId ? undefined : workspace.activeFile,
      },
